...
export AICROWD_DATASET_NAME="threeDotsCacheSmall"
for latentDim in 10
do
  for beta in 4
  do
    ...
    do
      echo $latentDim
      python ./jlonevae_lib/train/train_jlonevae_models.py --beta $beta --gamma $gamma --latent-dim $latentDim --epochs 6 --annealingBatches 10000
    done
  done
done
